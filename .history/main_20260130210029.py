...
header_bottom_gap = 20  # extra space below headers
...
def draw_how_to_play(mouse, scroll_delta=0):
    ...
    # ---------- TEXT ----------
    y_offset = panel_y + 50 + how_to_scroll  # start below panel title
    line_spacing = 28
    ...
    visible_text_height = panel_height - 50  # space below panel title
    if total_text_height > visible_text_height:
        max_scroll = visible_text_height - total_text_height - 20  # 20 px bottom padding
    else:
        max_scroll = 0

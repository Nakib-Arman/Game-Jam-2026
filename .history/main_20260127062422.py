...
HOW_TO_PLAY_TEXT = [
    "🎯 Objective",
    "Navigate the cave and reach the exit safely. Collect 
    resources, manage your energy and light, and avoid monsters while making strategic decisions about when to use or trade your items.",
    "",
    "🗺️ Collectible Items",

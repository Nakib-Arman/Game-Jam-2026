...
emoji_font = pygame.font.Font("NotoEmoji-Regular.ttf", 32)
...
def draw_how_to_play(mouse, scroll_delta=0):
    ...
    for line in HOW_TO_PLAY_TEXT:
        ...
        is_emoji_line = line[0] in "🎯🗺️⚡💱🐉⚠️🏁"
        font = emoji_font if is_emoji_line else (font_medium if is_header else font_text)

...
def draw_how_to_play(mouse, scroll_delta=0):
    ...
    for line in HOW_TO_PLAY_TEXT:
        ...
        for word in words:
            ...
            if test_surf.get_width() > max_text_width:
                screen.blit(font.render(current_line, True, (255, 255, 255)), (panel_x + 20, y_offset))
    ...
    visible_text_height = panel_height - 50 - top_padding - bottom_padding  # account for top & bottom padding

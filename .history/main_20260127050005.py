...
map_btn_img = pygame.image.load("buttons/map_btn.jpg").convert_alpha()
trade_btn_img = pygame.image.load("buttons/inventory.jpg").convert_alpha()

# Optional: scale to fit the button size
map_btn_img = pygame.transform.scale(map_btn_img, (100, 40))
trade_btn_img = pygame.transform.scale(trade_btn_img, (100, 40))

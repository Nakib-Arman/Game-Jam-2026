...
HOW_TO_PLAY_TEXT = [
    "🎯 OBJECTIVE",
    "Escape the cave by reaching the exit. Explore carefully, collect resources, manage your energy and light, and survive the monsters lurking in the darkness.Use the arrow keys to move the player up, down, left and right. As the time progresses, the player looses it's energy causing him to move slower. Lights",
    "",

...
def draw_how_to_play(mouse, scroll_delta=0):
    ...
    text_surface = pygame.Surface((panel_width - 40, panel_height - 50), pygame.SRCALPHA)
    ...
    for line in HOW_TO_PLAY_TEXT:
        ...
        for word in words:
            ...
            if test_surf.get_width() > text_surface.get_width():
    ...
    screen.blit(text_surface, (panel_x + 20, panel_y + 50), area=pygame.Rect(0, 0, panel_width - 40, panel_height - 50))

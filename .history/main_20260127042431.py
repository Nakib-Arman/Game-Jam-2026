...
def draw_trade_window(mouse):
    """Draws a small trade window on top of the game screen."""
    ...
    overlay = pygame.Surface((SCREEN_WIDTH, SCREEN_HEIGHT), pygame.SRCALPHA)
    overlay.fill((0, 0, 0, 150))  # darken the background
    screen.blit(overlay, (0, 0))

    # Draw window rectangle
    pygame.draw.rect(screen, (50, 50, 50), (window_x, window_y, window_w, window_h))
    ...
    # Correct rect inside the small window
    ...
    pygame.draw.rect(screen, button_color, rect)        # Only the button
    pygame.draw.rect(screen, (200, 200, 200), rect, 2) # Button border

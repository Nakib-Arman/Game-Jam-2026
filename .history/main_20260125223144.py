...
LIGHT_DRAIN_PER_SEC = 2  # light drains 2% per second
...
def draw_light_overlay():
    ...
    overlay.fill((0, 0, 0, 220))  # darkness alpha

    # Circle radius proportional to light percentage
...
while running:
    ...
    if show_map:
        ...
        draw_world()
        draw_light_overlay()  # 🔥 light circle

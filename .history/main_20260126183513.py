...
def draw_home_menu(mouse_pos):
    ...
    buttons["new"] = pygame.Rect(SCREEN_WIDTH // 2 - btn_w // 2, start_y, btn_w, btn_h)
    buttons["continue"] = pygame.Rect(SCREEN_WIDTH // 2 - btn_w // 2, start_y + gap, btn_w, btn_h)
    buttons["quit"] = pygame.Rect(SCREEN_WIDTH // 2 - btn_w // 2, start_y + gap * 2, btn_w, btn_h)

    for key, rect in buttons.items():
        draw_button(rect, key.upper(), rect.collidepoint(mouse_pos))

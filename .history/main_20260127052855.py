...
#     # ---------- RIGHT PANEL (ONLY PARTIAL COVER) ----------
#     panel_width = 420
#     panel_x = SCREEN_WIDTH - panel_width

#     panel_surface = pygame.Surface((panel_width, SCREEN_HEIGHT))
#     panel_surface.fill((25, 25, 25))
#     panel_surface.set_alpha(230)   # Slight transparency so image edge shows
...
def draw_menu(mouse):
    ...
    title = title_font.render("SHADOW OF DEATH", True, (230, 230, 230))
    screen.blit(
        title,
        title.get_rect(center=(panel_x + panel_width // 2, 120))
    )

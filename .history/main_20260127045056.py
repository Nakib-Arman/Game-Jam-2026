...
def draw_trade_window(mouse):
    ...
    options = [
        ...
        ("FOOD_LIGHT",  f"Food → +50% Light ({inventory['FOOD']})"),
        ("FOOD_MAP",    f"Food → Map x1 ({inventory['FOOD']}/{inventory['MAP']})"),
        ("MAP_ENERGY",  f"Map → +50% Energy ({inventory['MAP']})"),
        ("MAP_LIGHT",   f"Map → +50% Light ({inventory['MAP']})"),
        ("BACK",        "Done")
    ]
